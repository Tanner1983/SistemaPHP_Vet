...
<html>
    ...
    <div class="gallery" align="left">    
        ...
        <form method="POST" action="b_paciente2.php" class="formulario"> 
            <div class="row">
                <div class="col-25">
                ...
                <div class="col-25">
                    ...
                    <div class="col-75">
                        <select id="tipo" name="tipo" required>                            
                            <option value="id_cl">ID Dueño</option>
                            <option value="no_mas">Nombre Mascota</option>                           
                            <option value="co_mas">Color</option>
                            <option value="ed_mas">Edad</option>
                            <option value="pe_mas">Peso</option>
                            <option value="ge_mas">Genero</option>
                            <option value="ob_mas">Observaciones</option>
                        </select>
                    </div>
            </div>    
            <div class="row">
