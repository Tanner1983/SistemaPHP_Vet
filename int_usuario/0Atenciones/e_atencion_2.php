            ...
            if ($resp){                 
                ...
                <?php foreach ($resp as $row):?>   
                    <tr>
                        ...
                        <td><a href="ticket.php?id=<?php echo $row['id_cl']; ?>"><img src="../../image/ticket.png" width="35"></a>
                            <a href="e_atencion_3.php?id=<?php echo $row['id_ticket']; ?>"><img src="../../image/edit.png" width="35"></a> 
                            <a href="deletear.php?id=<?php echo $row['id_ticket']; ?>" onclick="return confirmation()"><img src="../../image/eliminar.png" width="35"></a>
                    </tr>  
