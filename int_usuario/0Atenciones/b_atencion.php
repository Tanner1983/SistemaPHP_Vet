...
<html>
    ...
    <div class="gallery" align="left">    
        ...
        <form method="POST" action="b_atencion2.php" class="formulario"> 
            <div class="row">
                <div class="col-25">
                ...
                <div class="col-25">
                    ...
                    <div class="col-75">
                        <select id="tipo" name="tipo" required>                            
                            <option value="id_ticket">N° de ticket</option>
                            <option value="nom_cl">Nombre Cliente</option>                           
                            <option value="fe_ticket">Fecha</option>
                            <option value="modo_ticket">Estado(A o P)</option>
                            <option value="de_ticket">Peso</option>                           
                        </select>
                    </div>
            </div>    
            <div class="row">
