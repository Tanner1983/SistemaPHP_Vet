    ...
    <div class="gallery" align="left">           
        ...
        ?>                
             <tr>
                    ...
                    <td>
                        <a href="e_ficha2.php?id=<?php echo $row['id_ficha']; ?>"><img src="../../image/edit.png" width="35"></a> 
                        <a href="deletear.php?id=<?php echo $row['id_ficha']; ?>" onclick="return confirmation()"><img src="../../image/eliminar.png" width="35"></a>
                    </td>
