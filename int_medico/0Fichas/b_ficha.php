...
<html>
    ...
    <div class="gallery" align="left">    
        ...
        <form method="POST" action="b_ficha2.php" class="formulario"> 
            <div class="row">
                <div class="col-25">
                ...
                <div class="col-25">
                    ...
                    <div class="col-75">
                        <select id="tipo" name="tipo" required>                            
                            <option value="id_ficha">ID Ficha</option>
                            <option value="id_cl">Id Cliente</option>                           
                            <option value="fe_ticket">Fecha</option>
                            <option value="pro_ficha">Problema consulta</option>
                        </select>
                    </div>
            </div>    
            <div class="row">
