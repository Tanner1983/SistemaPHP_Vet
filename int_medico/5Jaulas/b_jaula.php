...
<html>
    ...
    <div class="gallery" align="left">    
        ...
        <form method="POST" action="b_jaula2.php" class="formulario"> 
            <div class="row">
                <div class="col-25">
                ...
                <div class="col-25">
                    ...
                    <div class="col-75">
                        <select id="tipo" name="tipo" required>                            
                            <option value="id_jaula">ID</option>
                            <option value="med_jaula">Medidas</option>                           
                            <option value="dis_jaula">Disponiblidad</option>
                            <option value="des_jaula">Disponiblidad</option>
                        </select>
                    </div>
            </div>    
            <div class="row">
