...
<!-- Main Container -->
  ...
  <!-- Header -->
    ...
    <div class="gallery" align="left">  
        <?php
                $query = mysqli_query($link, "SELECT * FROM pt_tbrazas WHERE id_raza='$id'");
        ...
        <div class="formulario">
                     <form action="editar.php" method="POST">
                        <div class="row">
                            ...
                            <div class="col-75">
                                <input type="text" id="id" name="id" value="<?php echo $row['id_raza']; ?>" maxlength="5" readonly="readonly" required >
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                                <input type="text" id="nombre" name="nombre" value="<?php echo $row['nom_raza']; ?>" required>
                            </div>
                        </div>   
                        <div class="row">
                            <div class="col-25">
