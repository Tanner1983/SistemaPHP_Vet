...
<!-- Main Container -->
  ...
  <!-- Header -->
    ...
    <div class="gallery" align="left">    
        ...
        <form method="POST" action="busquedap3.php" class="formulario"> 
            <div class="row">
                <div class="col-25">
                ...
                <div class="col-25">
                    ...
                    <div class="col-75">
                        <select id="tipo" name="tipo" required>                            
                            ...
                            <option value="tip_pro">Tipo</option>
                            <option value="mar_pro">Marca</option>
                            <option value="des_pro">Descripcion</option>
                            <option value="prc_pro">Precio Costo</option>
                            <option value="prv_pro">Precio Venta</option>                            
                        </select>
                    </div>
            </div>    
            <div class="row">
