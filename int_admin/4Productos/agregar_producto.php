        ...
        <div class="formulario">
                     <form action="agregar.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-75">
                                <input type="text" id="tipo" name="tipo" placeholder="Ingrese tipo.." required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                                <input type="text" id="marca" name="marca" placeholder="Ingrese Marca.." required>
                            </div>
                        </div>                         
                        <div class="row">
                            <div class="col-25">
                        ...
                        <div class="row">
                            ...
                            <div class="col-75">
                                <input type="text" id="pc" name="pc" placeholder="Ingrese Precio.." required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                                <input type="text" id="pv" name="pv" placeholder="Ingrese Precio.." required>
                            </div>
                        </div>   
                        <div class="row">
                            <div class="col-25">
