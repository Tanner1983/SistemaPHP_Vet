...
<!-- Main Container -->
  ...
  <!-- Header -->
    ...
    <div class="gallery" align="left">  
        <?php
                $query = mysqli_query($link, "SELECT * FROM pt_tbservicio  WHERE id_serv='$id'");
        ...
        <div class="formulario">
                     <form action="editar.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-75">
                                <input type="text" id="id" name="id" placeholder="Numero identificacion.." value="<?php echo $row['id_serv']; ?>" maxlength="5" readonly="readonly" required >
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                                <input type="text" id="nombre" name="nombre" placeholder="Ingrese Nombre.." value="<?php echo $row['nomb_serv']; ?>" required>
                            </div>
                        </div>                         
                        <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                                <input type="text" id="precio" name="precio" placeholder="Ingrese Precio.." value="<?php echo $row['prec_serv']; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-75">
                                <input type="text" id="desc" name="desc" placeholder="Ingrese Descripcion.." value="<?php echo $row['desc_serv']; ?>" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-25">
