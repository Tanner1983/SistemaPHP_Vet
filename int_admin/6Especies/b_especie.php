...
<html>
    ...
    <div class="gallery" align="left">    
        ...
        <form method="POST" action="b_especie2.php" class="formulario"> 
            <div class="row">
                <div class="col-25">
                ...
                <div class="col-25">
                    ...
                    <div class="col-75">
                        <select id="tipo" name="tipo" required>                            
                            <option value="id_especie">ID</option>
                            <option value="nom_especie">Nombre</option>                           
                            <option value="des_especie">Descripcion</option>
                        </select>
                    </div>
            </div>    
            <div class="row">
