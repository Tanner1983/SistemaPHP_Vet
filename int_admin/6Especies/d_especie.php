...
<!-- Main Container -->
  ...
  <!-- Header -->
    ...
    <div class="gallery" align="left">           
        ...
        $usuarioModel = new especie();
        $reg = $usuarioModel->listaespecie();
        if ($reg){        
        ?>
        <div><br>
        <table align="center">
        ...
        ?>
             ...
             <tr>
                    ...
                    <td>
                        <a href="deletear.php?id=<?php echo $row['id_especie']; ?>" onclick="return confirmation()"><img src="../../image/eliminar.png" width="35"></a> 
                    </td>
                </tr>
