...
<!-- Main Container -->
  ...
  <!-- Header -->
    ...
    <div class="gallery" align="left">  
        <?php
                $query = mysqli_query($link, "SELECT * FROM pt_tbespecie  WHERE id_especie='$id'");
        ...
        <div class="formulario">
                     <form action="editar.php" method="POST">
                        <div class="row">
                            ...
                            <div class="col-75">
                                <input type="text" id="id" name="id" placeholder="Numero identificacion.." value="<?php echo $row['id_especie']; ?>" maxlength="5" readonly="readonly" required >
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                                <input type="text" id="nombre" name="nombre" placeholder="Ingrese Nombre.." value="<?php echo $row['nom_especie']; ?>" required>
                            </div>
                        </div>                         
                        <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                                <input type="text" id="desc" name="desc" placeholder="Ingrese Descripcion.." value="<?php echo $row['des_especie']; ?>"required>
                            </div>
                        </div>                                             
                        <div class="row">
                            <p>
