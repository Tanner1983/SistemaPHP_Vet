                ...
                <div class="col-25">
                    ...
                    <div class="col-75">
                        <select id="tipo" name="tipo" required>                            
                            ...
                            <option value="nom_usuario">Nombre</option>
                            <option value="ape_usuario">Apellido</option>
                            <option value="ema_usuario">E-mail</option>
                            <option value="tip_usuario">Tipo de Usuario</option>
                        </select>
                    </div>
            </div>    
            <div class="row">
