...
<!-- Main Container -->
  ...
  <!-- Header -->
    ...
    <div class="gallery" align="left">           
        ...
        $usuarioModel = new jaula();
        $reg = $usuarioModel->listajaula();
        if ($reg){        
        ?>
        <div><br>
        <table align="center">
        ...
        ?>
             ...
             <tr>
                    <td><?php echo $row['id_jaula']; ?></td>
                    <td><?php echo $row['med_jaula']; ?></td>
                    <td><?php echo $row['dis_jaula']; ?></td>
                    <td><?php echo $row['des_jaula']; ?></td>
                    <td>
                        <a href="deletear.php?id=<?php echo $row['id_jaula']; ?>" onclick="return confirmation()"><img src="../../image/eliminar.png" width="35"></a> 
                    </td>
                </tr>
